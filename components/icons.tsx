// Small shared icon set (hand-drawn SVGs, no external icon library),
// used for compact action buttons that stay a fixed size at any screen width.
...
export function TagIcon() {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 2H2v10l9.29 9.29a1 1 0 0 0 1.41 0l8.29-8.29a1 1 0 0 0 0-1.41z" />
